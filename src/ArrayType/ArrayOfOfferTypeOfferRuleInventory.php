...
class ArrayOfOfferTypeOfferRuleInventory extends AbstractStructArrayBase
{
     ...
     * @param \StructType\Inventory[] $inventory
     * @return \ArrayType\ArrayOfOfferTypeOfferRuleInventory
     */
    public function setInventory(array $inventory = array())
    {
        foreach ($inventory as $arrayOfOfferTypeOfferRuleInventoryInventoryItem) {
            ...
            if (!$arrayOfOfferTypeOfferRuleInventoryInventoryItem instanceof \StructType\Inventory) {
                throw new \InvalidArgumentException(sprintf('The Inventory property can only contain items of \StructType\Inventory, "%s" given', is_object($arrayOfOfferTypeOfferRuleInventoryInventoryItem) ? get_class($arrayOfOfferTypeOfferRuleInventoryInventoryItem) : gettype($arrayOfOfferTypeOfferRuleInventoryInventoryItem)), __LINE__);
            }
        }
