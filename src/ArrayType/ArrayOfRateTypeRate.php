...
/**
 * This class stands for ArrayOfRateTypeRate ArrayType
 * @subpackage Arrays
 */
class ArrayOfRateTypeRate extends AbstractStructArrayBase
{
    /**
     * The Rate
    ...
    public $Rate;
    /**
     * Constructor method for ArrayOfRateTypeRate
     * @uses ArrayOfRateTypeRate::setRate()
     ...
     * @param \Devlabs91\TravelgatePushApi\StructType\Rate[] $rate
     * @return \Devlabs91\TravelgatePushApi\ArrayType\ArrayOfRateTypeRate
     */
    public function setRate(array $rate = array())
    {
        foreach ($rate as $arrayOfRateTypeRateRateItem) {
            // validation for constraint: itemType
            if (!$arrayOfRateTypeRateRateItem instanceof \Devlabs91\TravelgatePushApi\StructType\Rate) {
                throw new \InvalidArgumentException(sprintf('The Rate property can only contain items of \Devlabs91\TravelgatePushApi\StructType\Rate, "%s" given', is_object($arrayOfRateTypeRateRateItem) ? get_class($arrayOfRateTypeRateRateItem) : gettype($arrayOfRateTypeRateRateItem)), __LINE__);
            }
        }
        $this->Rate = $rate;
        return $this;
