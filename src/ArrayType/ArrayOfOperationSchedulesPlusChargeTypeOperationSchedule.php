...
/**
 * This class stands for ArrayOfOperationSchedulesPlusChargeTypeOperationSchedule
 * ArrayType
 * @subpackage Arrays
 */
class ArrayOfOperationSchedulesPlusChargeTypeOperationSchedule extends AbstractStructArrayBase
{
    /**
