...
/**
 * This class stands for OTA_HotelRatePlanNotifRS StructType
 * @subpackage Structs
 */
class OTA_HotelRatePlanNotifRS extends AbstractStructBase
{
    /**
     * The Errors
    ...
    /**
     * Constructor method for OTA_HotelRatePlanNotifRS
